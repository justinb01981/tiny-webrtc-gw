...
## Demo:
  ...
  [&#x261D;WHIP url (for OBS)](https://www.domain17.net:8016/content/tinywm.obscfg.png)

## Pics:
  ![&#9729;"cloud"&#9729;](https://github.com/justinb01981/tiny-webrtc-gw/blob/master/content/webrtc-bcast-obs-gaming.png?raw=true)
  ![Web interface + lobby + chat](https://github.com/justinb01981/tiny-webrtc-gw/blob/master/content/webrtc-morn.png?raw=true)
  ![test image](https://github.com/justinb01981/tiny-webrtc-gw/blob/master/IMG-8094.jpg?raw=true)
  ![configuring OBS](https://github.com/justinb01981/tiny-webrtc-gw/blob/master/content/tinywm.obscfg.png?raw=true)
...
## Caveats:
  ...
  (maybe just use a (free) self-signed certificahttps://www.domain17.net:8016://www.domain17.net:8016/content/webrtc-morn.pngte
